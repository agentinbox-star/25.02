...
description: 'Mintlify дает полный контроль над внешним видом документации через файл docs.json'
icon: 'gear'
---

Каждому Mintlify сайту нужен файл `docs.json` с основными параметрами конфигурации. Подробнее о [свойствах](#properties) ниже.

## Свойства

<ResponseField name="name" type="string" required>
Название твоего проекта. Используется для глобального заголовка.
...
<ResponseField name="navigation" type="Navigation[]" required>
  Массив групп со всеми страницами в пределах каждой группы
  <Expandable title="Навигация">
    ...
    Относительные пути к markdown файлам, которые служат страницами.
